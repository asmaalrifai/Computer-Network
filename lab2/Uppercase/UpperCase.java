...
public class UpperCase extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        ...
        try {
        String rqMsg = " " + txt_msg.getText();

        // Create Client instance
        Client cl = new Client();
        cl.Connect("127.0.0.1", 7000);
        cl.SendMsg(rqMsg);
        
        // Receive response
        String rsMsg = cl.ReadMsg();
        txt_msg.setText(rsMsg);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpperCase.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
